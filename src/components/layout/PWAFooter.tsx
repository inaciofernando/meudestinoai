...
export const PWAFooter = () => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-[60] border-t border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/60" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
