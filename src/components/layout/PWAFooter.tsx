...
export const PWAFooter = () => {
  ...
  return (
    <footer className="w-full border-t border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/60" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
