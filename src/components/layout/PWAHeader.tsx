...
export const PWAHeader = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[60] w-full border-b border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/60" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
